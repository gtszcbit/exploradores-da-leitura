      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-8 px-4 pt-10 pb-16 sm:px-6 sm:pt-14 sm:pb-20 lg:grid-cols-2 lg:gap-12">
        <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
          ...
          <ul className="mt-7 flex flex-wrap justify-center gap-x-6 gap-y-2">
            {bullets.map((b) => (
              <li key={b.text} className="flex items-center gap-1.5 text-xs font-medium text-muted-foreground sm:text-sm">
                <b.icon className="size-3.5 text-accent sm:size-4" aria-hidden />
                {b.text}
              </li>
            ))}
          </ul>
