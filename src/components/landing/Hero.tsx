...
export function Hero() {
  return (
    <section id="topo" className="surface-paper relative overflow-hidden">
      ...
      <div className="relative mx-auto flex max-w-3xl flex-col items-center px-4 pt-10 pb-16 text-center sm:px-6 sm:pt-14 sm:pb-20">
        ...
        <p className="reveal-in mx-auto mt-5 max-w-xl text-base leading-relaxed text-muted-foreground sm:text-lg">
          Uma jornada lúdica com 100 missões para explorar sons, letras, sílabas, palavras e frases
          de um jeito muito mais divertido.
        </p>

        <div className="reveal-in relative mt-9 w-full max-w-md [animation-delay:150ms]">
